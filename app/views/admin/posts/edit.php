    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800 d-inline-block">Posts - Edit</h1>
                ...
                <form action="<?php echo URLROOT; ?>/posts/edit/<?php echo $data['id'] ;?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" id="" class="form-control">
                            <option value="<?php echo $data['category_post']->categoryId ?>"><?php echo $data['category_post']->name ?></option>
                            <?php foreach ($data['categories'] as $category) : ?>
                            <?php if ($data['category_post']->categoryId === $category->id) {
                                continue;
                            } ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="editor" rows="10" class="form-control <?php echo (!empty($data['content_err']) ? 'is-invalid' : '') ?>" ><?php echo $data['content']; ?></textarea>
                    ...
                    <input type="submit" value="Cập nhật bài viết" class="btn btn-primary btn-block">
                </form>
            </div>
            <!-- /.container-fluid -->
