    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php flash('message'); ?>
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 d-inline-block">Categories</h1>
          <a href="<?php echo URLROOT; ?>/categoryPost/add" class="btn btn-primary d-inline-block float-right"><i class="fa fa-plus"></i> Add Categories</a>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo URLROOT; ?>/categoryPost/edit/<?php echo $category->id; ?>" class="btn btn-warning" data-toggle="tooltip" data-placement="bottom" title="Chỉnh sửa"><i class="far fa-edit"></i></a>
                  <?php if($category->status) : ?>
                    <a href="<?php echo URLROOT; ?>/categoryPost/inactive/<?php echo $category->id; ?>" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Inactive"><i class="fas fa-times"></i></a>
                  <?php else : ?>
                    <a href="<?php echo URLROOT; ?>/categoryPost/active/<?php echo $category->id; ?>" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Active"><i class="fas fa-check"></i></a>
                  <?php endif; ?>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <form action="<?php echo URLROOT; ?>/categoryPost/delete/<?php echo $category->id; ?>" method="post">
