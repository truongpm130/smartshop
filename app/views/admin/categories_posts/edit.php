    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800 d-inline-block">Categories - Edit</h1>
                <a href="<?php echo URLROOT; ?>/admin/categoriesPosts" class="btn btn-secondary d-inline-block float-right"><i class="fa fa-arrow-left"></i> Back</a>

                <!-- Add Category -->
                <div class="row">
                    <div class="col-md-6 offset-3">
                        <form action="<?php echo URLROOT; ?>/categoryPost/edit/<?php echo $data['id'] ?>" method="post">
